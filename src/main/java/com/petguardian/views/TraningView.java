...
public class TraningView {
    ...
    public void initialize() {
        ...
        // Example course items with YouTube video URLs
        coursesBox.getChildren()
                .add(createCourseItem("https://www.youtube.com/embed/GGefmpfvPlI", "Obedience Courses",
                        "By John Smith", "4.9 (335)"));
        coursesBox.getChildren().add(createCourseItem("https://www.youtube.com/embed/GGefmpfvPlI",
                "Specialty Classes & Workshops", "By Duke Fuzzington", "5.0 (500)"));
        // coursesBox.getChildren().add(createCourseItem("http://techslides.com/demos/sample-videos/small.mp4",
        // "Puppy Kindergarten and Playgroups", "By Sir Fluffington", "5.0 (500)"));
        // coursesBox.getChildren().add(createCourseItem("http://techslides.com/demos/sample-videos/small.mp4",
        // "Canine Good Citizen Test", "By Baron Fuzzypaws", "4.8 (220)"));
        // coursesBox.getChildren()
        // .add(createCourseItem("http://techslides.com/demos/sample-videos/small.mp4",
        // "Therapy Dogs", "By Duke Fuzzington", "5.0 (500)"));
    ...
    private HBox createCourseItem(String videoURL, String title, String author, String rating) {
        // WebView for the YouTube video
        ...
        // HBox for video and text
        HBox courseBox = new HBox(10, webView, textBox);
