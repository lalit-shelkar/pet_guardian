...
public class TraningView {
    ...
    public void initialize() {
        ...
        coursesBox.getChildren()
                .add(createCourseItem("Traning/photo1.jpg", "Obedience Courses", "By John Smith", "4.9 (335)"));
        ...
        coursesBox.getChildren()
                .add(createCourseItem("Traning/photo5.jpg", "Therapy Dogs", "By Duke Fuzzington", "5.0 (500)"));
