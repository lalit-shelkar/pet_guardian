...
public class DoctorGetStarted {
    ...
    // ComboBox<String> availableInput = new
    // ComboBox<>(FXCollections.observableArrayList("Yes", "No"));
    ...
    // GridPane.setConstraints(dateButtonsBox, 1, 13); // Adjusted to match your
    // layout
    ...
    // dateButton.setStyle("-fx-background-color: green; -fx-text-fill: white;"); //
    // Selected style

    // // You can handle further logic here based on selected date
    // } else {
    // // Handle deselection if needed
    // dateButton.setStyle("-fx-background-color: red; -fx-text-fill: black;"); //
    // Deselected style
